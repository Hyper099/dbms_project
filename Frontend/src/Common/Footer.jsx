...
export default function Footer() {
   return (
      <footer className="text-gray-600 body-font border-1">
               ...
               {[...Array(3)].map((_, i) => (
                  <div key={i} className="lg:w-1/4 md:w-1/2 w-full px-4">
                     ...
                     <nav className="list-none mb-10">
                        {['First Link', 'Second Link', 'Third Link', 'Fourth Link'].map((text, j) => (
                           <li key={j}>
                              <a href="#" className="text-gray-600 hover:text-gray-800">{text}</a>
                           </li>
                        ))}
                     </nav>
                  </div>
